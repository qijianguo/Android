...
public final class TempData {
	...
	private String hikvisionServerAddr;
	
	public String getHikvisionServerAddr() {
		return hikvisionServerAddr;
	}

	public void setHikvisionServerAddr(String hikvisionServerAddr) {
		this.hikvisionServerAddr = hikvisionServerAddr;
	}
