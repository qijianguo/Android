...
public class SpotInfo {
	...
	private String minute_water_sewage; //污水流量  B01
	private String minute_water_nh3n; //氨氮  060
	private String minute_water_pho;//总磷 A08
	private String minute_water_ntu;  // 浊度NTU
	private String minute_water_ph; // PH
	private String minute_water_N;	// 总氮
	private String status;	//水->在线/离线
	
	public String getMinute_water_sewage() {
		return minute_water_sewage;
	}

	public void setMinute_water_sewage(String minute_water_sewage) {
		this.minute_water_sewage = minute_water_sewage;
	}

	public String getMinute_water_nh3n() {
		return minute_water_nh3n;
	}

	public void setMinute_water_nh3n(String minute_water_nh3n) {
		this.minute_water_nh3n = minute_water_nh3n;
	}

	public String getMinute_water_pho() {
		return minute_water_pho;
	}

	public void setMinute_water_pho(String minute_water_pho) {
		this.minute_water_pho = minute_water_pho;
	}

	public String getMinute_water_ntu() {
		return minute_water_ntu;
	}

	public void setMinute_water_ntu(String minute_water_ntu) {
		this.minute_water_ntu = minute_water_ntu;
	}

	public String getMinute_water_ph() {
		return minute_water_ph;
	}

	public void setMinute_water_ph(String minute_water_ph) {
		this.minute_water_ph = minute_water_ph;
	}

	public String getMinute_water_N() {
		return minute_water_N;
	}

	public void setMinute_water_N(String minute_water_N) {
		this.minute_water_N = minute_water_N;
	}
