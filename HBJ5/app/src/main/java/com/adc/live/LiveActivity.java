...
public class LiveActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		live_goback = (Button) findViewById(R.id.live_goback);
		...
		mDialog = new AlertDialog.Builder(this).setSingleChoiceItems(datas, 0,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Log.e("heheda", "111111111112222222223333333333");
						mDialog.dismiss();
	...
	private void sendCtrlCmd(final int gestureID) {
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				Log.e("heheda", "111111111111111111111");
				...
				Log.e(Constants.LOG_TAG, "sendStartPTZCmd ret:" + ret);
			}
		}).start();
	}
	...
	private String getPlayUrl(int streamType) {
		...
		Log.e("hihida", "servAddr = "+mAddress);
		// 登录返回的sessionid
