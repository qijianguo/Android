...
public class DataContrastActivity extends Activity {
	...
	public boolean onKeyDown(int keyCode, android.view.KeyEvent event) {
		if(keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0){
			Intent intent = new Intent(DataContrastActivity.this,WuhanMainActivity.class);		
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sjdb_goback.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//Intent goback_intent = new Intent(DataContrastActivity.this,MainTabActivity.class);
				Intent intent = new Intent(DataContrastActivity.this,WuhanMainActivity.class);
				startActivity(intent);
				finish();
			}
